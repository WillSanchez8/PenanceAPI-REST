...
INSERT INTO `homework` VALUES (1,'lola','vaca',NULL,'docs\\1705014929679.pdf',5545415,'animal');
...
CREATE TABLE `imagen` (
  ...
  PRIMARY KEY (`idI`),
  KEY `noEmployee` (`noEmployee`),
  CONSTRAINT `imagen_ibfk_1` FOREIGN KEY (`noEmployee`) REFERENCES `admins` (`noEmployee`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `imagen` VALUES (1,'hola','hola','0000-00-00','img\\1705009409920.jpg',5545415),(3,'hola','laura','2024-10-10','img\\1705010453013.jpeg',5545415);
...
CREATE TABLE `users_work` (
  ...
  KEY `noStudent` (`noStudent`),
  KEY `idH` (`idH`),
  CONSTRAINT `users_work_ibfk_1` FOREIGN KEY (`noStudent`) REFERENCES `users` (`noStudent`),
  CONSTRAINT `users_work_ibfk_2` FOREIGN KEY (`idH`) REFERENCES `homework` (`idH`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `users_work` WRITE;
/*!40000 ALTER TABLE `users_work` DISABLE KEYS */;
/*!40000 ALTER TABLE `users_work` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-01-14 16:41:29
